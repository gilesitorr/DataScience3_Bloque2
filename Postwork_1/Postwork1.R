...
# Del data frame que resulta de importar los datos a R, extrae 
...
# Consulta cómo funciona la función table en R al ejecutar en 
# la consola ?table

?table

# Posteriormente elabora tablas de frecuencias relativas para 
...
# La probabilidad (conjunta) de que el equipo que juega en 
# casa anote x goles y el equipo que juega como visitante 
